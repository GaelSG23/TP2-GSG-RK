...
public class TestOuvrage {
    ...
    public void testOuvrages() {
        ...
        Auteur albertine = new Auteur("Albertine", "Tremblay", new Pays("Etats-Unis", "EEE"));
        Auteur john = new Auteur("John", "Smith", new Pays("Canada", "CCC"));
        ...
        Ouvrage livre3 = new Ouvrage("Musique du hasard", new Auteur("Paul", "Auster", new Pays("Etats-Unis", "EEE")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
        ...
        Ouvrage livre4 = new Ouvrage("Test", new Auteur("A", "B", new Pays("Etats-Unis", "EEE")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);

        System.out.println("\n-----Tests de la  méthode equals()-----------");
        //Deux ouvrages égaux
        Ouvrage livre5 = new Ouvrage("Test", new Auteur("A", "B", new Pays("Etats-Unis", "EEE")), Ouvrage.Format.PAPIER, null, 5);
        Ouvrage livre6 = new Ouvrage("Test", new Auteur("A", "B", new Pays("Etats-Unis", "EEE")), Ouvrage.Format.PAPIER, LocalDate.now(), 10);
        //Un qui ne l'est pas
        Ouvrage livre7 = new Ouvrage("Test", new Auteur("Z", "B", new Pays("Etats-Unis", "EEE")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
    ...
    private void testTrouver() {
        ...
        List<Ouvrage> resultat = bibliotheque.trouverOuvrages(new Auteur("Albertine", "Tremblay", new Pays("Canada", "CCC")));
    ...
    public void nosTestOuvrage() {
        ...
        ouvrages.add(new Ouvrage("Game of Thrones", auteur1));
        ouvrages.add(new Ouvrage("Lors of the Rings", auteur2));

        Ouvrage harryPotter = new Ouvrage("Harry Potter", auteur3);
        ouvrages.add(harryPotter);
